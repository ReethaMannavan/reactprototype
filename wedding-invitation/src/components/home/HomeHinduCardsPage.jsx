...
import HomeHinduCardsData from "../data/HomeHinduCards";

export default function HomeHinduWeddingCardsPage() {
  const {
    wishlist,
    isInWishlist,
 ...
 const navigate = useNavigate();
  ...
  return (
    <div className="bg-lavender min-h-screen py-10 px-6 font-poppins mb-10">
      <h1 className="text-3xl font-semibold text-center mb-10">
       Simple and Affordable Wedding Cards
      </h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center">
        {HomeHinduCardsData.slice(0, 6).map((card) => {
